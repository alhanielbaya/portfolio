export default [
  {
    name: 'Tweeter',
    pic: {
      url: 'https://i.ibb.co/gyKkh1Y/tweeter-full.png',
      alt: 'Tweeter App'
    },
    shortDesc:
      'A twitter clone with basic functionalities like logging in, posting a tweet and following users. Uses Oauth technology, specifically Facebook and Google, for authentication and authorization and MySQL for the back-end. Built with mobile-first concepts and also a Progressive Web App.',
    technologies: [
      'react',
      'typescript',
      'docker',
...

  {
    ...
    pic: {
      url: 'https://i.ibb.co/TM3hmxV/express-user-auth.png',
      alt: 'User Auth App'
    },
    shortDesc:
      'User authentication with node.js and express built with basic authorization concepts.',
...

  {
    name: 'Hourly Weather',
    pic: {
      url: 'https://i.ibb.co/k88kDWn/hourly-weather.jpg',
...

  {
    name: 'Explore Beers',
    pic: {
      url: 'https://i.ibb.co/fDDzhLZ/explore-beers.jpg',
